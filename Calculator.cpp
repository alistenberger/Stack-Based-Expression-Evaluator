...
//Finally, if the expression is done reading, if there are any commands left on the stack, move them to postfix
  std::cout << "Reached line 36" << std::endl;
  while (!tempStack->is_empty ()) {
    std::cout << "Reached line 38" << std::endl;
    Expr_Command * tempCommand = tempStack->top ();
    std::cout << "Reached line 40" << std::endl;
    postfix.append (tempCommand);
    std::cout << "Reached line 42" << std::endl;
    tempStack->pop ();
    std::cout << "Reached line 44" << std::endl;
  }
  std::cout << "Deleting tempStack" << std::endl;
  delete tempStack;
  std::cout << "tempStack deleted" << std::endl;
